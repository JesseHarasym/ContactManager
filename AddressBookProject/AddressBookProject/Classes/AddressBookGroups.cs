...
namespace AddressBookProject.Classes
{
    ...
    public sealed class AddressBookGroups
    {
        ...
        public BasicGroup AddGroup(string groupName, List<ContactCard> contactCards, int groupID, int cardStartPos, int cardPos)
        {
            groupID++;
        ...
        public void EditGroup(string groupName, List<ContactCard> contactCards)
        {
