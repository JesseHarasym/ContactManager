...
namespace AddressBookProject
{
    ...
    public sealed class AddressBookContacts
    {
        ...
        public List<ContactCard> ContactCards = new List<ContactCard>();
        ...
        public ContactCard AddContactCard(int cardStartPos, int cardPos)
        {
        ...
        public IEnumerable<ContactCard> SearchContact(string searchCriteria, List<ContactCard> contactsVisible)
        {
